I used to keep logs of my daily productivity with .txt files but it got tedious after a while so I made an app that creates a txt if the txt for the day have not been created yet.
